...
with(power_data, {
    ## Plot 1
    plot(power_data$Global_active_power, xlab = "", ylab = "Global Active Power", type  = "l", xaxt = "n")
    axis(side = 1, at = days_index, labels = days) 
    ...
    ## Plot 3
    plot(power_data$Voltage, xlab = "datetime", ylab = "Voltage", type  = "l", xaxt = "n")
    axis(side = 1, at = days_index, labels = days) 
    
    ## Plot 4
    plot(power_data$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type  = "l", xaxt = "n")
    axis(side = 1, at = days_index, labels = days) 
})
dev.off()
